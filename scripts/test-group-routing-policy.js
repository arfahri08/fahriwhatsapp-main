...
async function main() {
    ...
    assert.match(indexSource, /groupWelcome\.isBotAdmin\(inboundGroupMetadata, sock, selfIdentityCandidates\)/)
    const adminGateIndex = indexSource.indexOf("groupWelcome.isBotAdmin(inboundGroupMetadata, sock, selfIdentityCandidates)")
